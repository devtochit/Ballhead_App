...
function CrypoDetails() {
    ...
    const stats = [
        { title: "Price of USD", value: `${cryptoDetails?.price && millify(cryptoDetails?.price)}`, icon: <DollarCircleOutlined /> },
    ...
    const genericStats = [
        ...
        { title: "Circular Supply ", value: `${cryptoDetails?.supply?.circulating && millify(cryptoDetails?.supply?.circulating)}`, icon: <ExclamationCircleOutlined /> },
    ]
    return (
        <>
                ...
                {/* <Col className="stats-container">
                    <Col className="coin-value-statistics">
                        <Col className=" coin-value-statistics-heading">
                            ...
                            <p> An overView showing the stattics of {cryptoDetails?.name}, such as the base and quote currency, the rank and trading volume</p>
                        </Col>
